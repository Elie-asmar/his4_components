...
function Spinner(props) {
  ...
  const classes = (0, _utils.mapToCssModules)((0, _classnames.default)(className, size ? "spinner-".concat(type, "-").concat(size) : false, "spinner-".concat(type), color ? "text-".concat(color) : false), cssModule);
