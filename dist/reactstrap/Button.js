...
function Button(props) {
  ...
  const btnOutlineColor = "btn".concat(outline ? '-outline' : '', "-").concat(color);
  const classes = (0, _utils.mapToCssModules)((0, _classnames.default)(className, 'btn', btnOutlineColor, size ? "btn-".concat(size) : false, block ? 'd-block w-100' : false, {
    active,
