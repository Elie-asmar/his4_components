...
class Modal extends _react.default.Component {
  ...
  close() {
    if (Modal.openCount <= 1) {
      const modalOpenClassName = (0, _utils.mapToCssModules)('modal-open', this.props.cssModule); // Use regex to prevent matching `modal-open` as part of a different class, e.g. `my-modal-opened`

      const modalOpenClassNameRegex = new RegExp("(^| )".concat(modalOpenClassName, "( |$)"));
  ...
  renderModalDialog() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", _extends({}, attributes, {
      className: (0, _utils.mapToCssModules)((0, _classnames.default)(dialogBaseClass, this.props.className, {
        ["modal-".concat(this.props.size)]: this.props.size,
        ["".concat(dialogBaseClass, "-centered")]: this.props.centered,
        ["".concat(dialogBaseClass, "-scrollable")]: this.props.scrollable,
        'modal-fullscreen': this.props.fullscreen === true,
        ["modal-fullscreen-".concat(this.props.fullscreen, "-down")]: typeof this.props.fullscreen === 'string'
