...
class Dropdown extends _react.default.Component {
  constructor(props) {
    ...
    this.toggleRef = /*#__PURE__*/_react.default.createRef(); // ref for DropdownToggle
  }
  ...
  render() {
    ...
    if (this.context.insideInputGroup) {
      ...
      }, /*#__PURE__*/_react.default.createElement(_reactPopper.Manager, null, this.props.children.map(child => /*#__PURE__*/_react.default.cloneElement(child, {
