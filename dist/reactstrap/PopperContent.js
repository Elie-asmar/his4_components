...
class PopperContent extends _react.default.Component {
  ...
  renderChildren() {
    ...
    const popperClassName = (0, _utils.mapToCssModules)((0, _classnames.default)(_popperClassName, placementPrefix ? "".concat(placementPrefix, "-auto") : ''), this.props.cssModule);
