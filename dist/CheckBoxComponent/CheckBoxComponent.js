...
class CheckBoxComp extends _react.Component {
  constructor(props) {
    super(props);

    _defineProperty(this, "onCheckChange", key => e => {
      this.setState({
  ...
  componentDidUpdate(prevProps) {
    if (!(0, _lodash.isEqual)(prevProps.checked, this.props.checked)) {
      this.setState({
        checked: this.props.checked
      });
    }
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(_reactIcheck.Checkbox, {
      cursor: "pointer",
      checkboxClass: "".concat(this.props.checkboxClassName ? this.props.checkboxClassName : "icheckbox_square-blue").concat(this.props.className ? " " + this.props.className : ""),
      increaseArea: this.props.increaseArea ? "20%" : "",
      checked: this.state.checked ? true : false,
      onChange: this.onCheckChange(this.props.name),
      label: this.props.description ? "<span style='margin:0px 20px 0px 7px'> ".concat(this.props.description, " </span>") : "<span></span>",
